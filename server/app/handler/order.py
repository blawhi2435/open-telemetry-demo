...
class OrderHandler:
    ...
    def get_order_by_id(self, user_id: int) -> entity.Order:
        self.logger.log(level=logging.INFO, user_id=user_id, order_id=None, extra={}, message="handler Get order by id started")
    ...
    def create_order(self, request: CreateOrderRequest):
            ...
            self.logger.log(level=logging.INFO, user_id=request.user_id, order_id=order.id, extra={}, message="handler Create order completed")
